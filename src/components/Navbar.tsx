          ...
          <div className="hidden md:flex items-center ml-6">
            {user ? (
              <div className="flex items-center space-x-3">
                ...
                <span className="text-body-small text-primary font-medium max-w-32 truncate">
                  {displayName}
                </span>
                <button
                  onClick={signOut}
                  className="cursor-pointer px-4 py-2 text-body-small text-secondary hover:text-primary hover:bg-tertiary-dark/50 rounded-medium transition-all duration-200 outline-none"
                >
                  Sign Out
                </button>
              </div>
              ...
              {user ? (
                <div className="bg-tertiary-dark/40 border border-border-light/50 rounded-large p-4">
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-1 min-w-0">
                      <h3 className="text-body-large text-primary font-semibold truncate">
                        {displayName}
                      </h3>
                      {userEmail && (
                        <p className="text-body-small text-secondary truncate mt-1">
                          {userEmail}
                        </p>
                      )}
                ...
                <div className="space-y-4 pb-4">
                  <div className="text-center py-3">
                    ...
                    <h3 className="text-body-large text-primary font-semibold mb-2">
                      Join Our Community
                    </h3>
                    <p className="text-body-small text-secondary mb-3">
                      Sign in to create posts, join communities, and connect
                      with others.
                    </p>
                  </div>
                  <button
